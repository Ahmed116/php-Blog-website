...
while ($DataRows = mysqli_fetch_array($Execute)) {
    ...
    ?>
                        ...
                        <tr>
                            ...
                            <td><a href="DeleteCommments.php?id=<?php echo $CommentId; ?>"><span
                                        class="btn btn-danger">Delete</span></a></td>
                            <td><a href="fullPost.php?id=<?php echo $ComentedPostID; ?>" target="_blank"><span
...
while ($DataRows = mysqli_fetch_array($Execute)) {
    ...
    ?>
                        ...
                        <tr>
                            ...
                            <td><a href="DisApproveComments.php?id=<?php echo $CommentId; ?>"><span
                                        class="btn btn-warning">Dis-Approve</span></a></td>
                            <td><a href="DeleteCommments.php?id=<?php echo $CommentId; ?>"><span
                                        class="btn btn-danger">Delete</span></a></td>
                            <td><a href="fullPost.php?id=<?php echo $ComentedPostID; ?>" target="_blank"><span
                                        class="btn btn-primary">Live Preview</span></a></td>
