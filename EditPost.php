...
if(isset($_POST["Submit"])){
    ...
    if(empty($Title)){
       ...
       Redirect_to("addNewPost.php");
        ...
        $Query ="UPDATE admin_panal SET datetime='$CurrentTime', title='$Title',category='$Category',
        auther='$Admin',image='$Image',post='$Post' WHERE id='$EditFromURL'";
...
<body>
    ...
    <input value="<?php echo $TitleToBeUpdated;?>"class="form-control" type="text" name="Title" id="title" >
    </div>
    ...
    <br>
    <input class="btn btn-info btn-block" type="submit" name="Submit" value="Update Post">
    <br>
    <br>
    </fieldset>
    </form>
